...
export const CAPTURE_SPEED = 14.5; // faster than this and the ball skips the cup
export const TELE_COOLDOWN_TICKS = 24;
export const JUMP_MIN_SPEED = 2.5;
export const BUMPER_KICK_MAX_SPEED = 21;
export const RAMP_MAX_SIN = 0.7; // steepest ramp: ~45°
export const MOVER_MAX_SPEED = 18; // a windmill / pendulum shoves, it does not launch
export const RUBBER_MAX_SPEED = 23; // the most a rubber wall hands back
export const BUMPER_KICK_MIN_APPROACH = 1.5; // creep into a bumper and it just bounces you
export const BUMPER_OUT_MAX = 16; // the fastest a bumper kick sends the ball out
